...
#		os.execvp("/workspace/na62-farm/Debug/na62-farm", paramList)
		with open("paramFile.txt", "w") as fd:
			fd.write("run {0}".format(" ".join(paramList)))
		#os.execvp("gdb", ["-x", "paramFile.txt", "na62-farm"])
#		os.system("gdb -x paramFile.txt na62-farm")
		os.system("gdb -x paramFile.txt /workspace/na62-farm/Debug/na62-farm")
